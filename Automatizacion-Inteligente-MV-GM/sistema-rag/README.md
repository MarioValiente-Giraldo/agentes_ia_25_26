...
![Diagrama del flujo RAG implementado en n8n](/img/flujo.png)
...
![Ejemplo de interacción con el chat del sistema RAG](/img/chat.png)
...
![Ejemplo de interacción con el chat del sistema RAG en terminal](/img/terminal.png)
